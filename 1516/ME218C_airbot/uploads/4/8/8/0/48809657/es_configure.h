...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "ReceivingService.h"
// the name of the Init function
#define SERV_3_INIT InitReceivingService
// the name of the run function
#define SERV_3_RUN RunReceivingService
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "PACService.h"
// the name of the Init function
#define SERV_4_INIT InitPACService
// the name of the run function
#define SERV_4_RUN RunPACService
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "SendingService.h"
// the name of the Init function
#define SERV_5_INIT InitSendingService
// the name of the run function
#define SERV_5_RUN RunSendingService
// How big should this services Queue be?
...
#define TIMER2_RESP_FUNC PostReceivingService
#define TIMER3_RESP_FUNC PostPACService
#define TIMER4_RESP_FUNC PostAnalogService
#define TIMER5_RESP_FUNC PostPACService
#define TIMER6_RESP_FUNC PostPACService
#define TIMER7_RESP_FUNC PostAnalogService
...
#define RECEIVE_TIMEOUT_TIMER 2
#define SENDING_TIMER 3
#define ANALOG_TIMER 4
#define RESEND_TIMER 5
#define ACTIVE_PAIR_TIMER 6
#define ANALOG_INIT_TIMER 7
#endif /* CONFIGURE_H */
